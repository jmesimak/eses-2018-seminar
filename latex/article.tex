...
Recovery from service failure                                                                            & \multicolumn{1}{c}{•} & \multicolumn{1}{c}{•} \\ \midrule
\begin{tabular}[c]{@{}l@{}}Adding subscribers without\\ modifications to rest of the system\end{tabular} & \multicolumn{1}{c}{•} &                       \\ \midrule
\begin{tabular}[c]{@{}l@{}}Allow subscribers to\\ control inbound message flow\end{tabular}              &                       & \multicolumn{1}{c}{•} \\ \midrule
\begin{tabular}[c]{@{}l@{}}Allow event system to\\ control outgoing message flow\end{tabular}            & \multicolumn{1}{c}{•} &                       \\ \midrule
\begin{tabular}[c]{@{}l@{}}Store identical messages\\ only once\end{tabular}                             & \multicolumn{1}{c}{•} &                       \\ \midrule
\begin{tabular}[c]{@{}l@{}}Secure communication\\ between publisher and subscriber\end{tabular}          &                       & \multicolumn{1}{c}{•} \\ \midrule
Non-exposed subscribers                                                                                  &                       & \multicolumn{1}{c}{•} \\ \bottomrule
\end{tabular}
\end{table}
